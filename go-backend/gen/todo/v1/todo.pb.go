...
const file_todo_v1_todo_proto_rawDesc = "" +
	"\n" +
	"\x12todo/v1/todo.proto\x12\atodo.v1\x1a\x1bbuf/validate/validate.proto\"\x84\x01\n" +
	"\x04Todo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x1c\n" +
	"\tcompleted\x18\x04 \x01(\bR\tcompleted\x12\x16\n" +
	"\x06secret\x18\x05 \x01(\tR\x06secret\"v\n" +
	"\x11CreateTodoRequest\x12 \n" +
	"\x05title\x18\x01 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xff\x01R\x05title\x12/\n" +
	"\vdescription\x18\x02 \x01(\tB\b\xbaH\x05r\x03\x18\xe8\aH\x00R\vdescription\x88\x01\x01B\x0e\n" +
	"\f_description\"7\n" +
	"\x12CreateTodoResponse\x12!\n" +
	"\x04todo\x18\x01 \x01(\v2\r.todo.v1.TodoR\x04todo\")\n" +
	"\x0eGetTodoRequest\x12\x17\n" +
	"\x02id\x18\x01 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00R\x02id\"4\n" +
	"\x0fGetTodoResponse\x12!\n" +
	"\x04todo\x18\x01 \x01(\v2\r.todo.v1.TodoR\x04todo\"R\n" +
	"\x10ListTodosRequest\x12\x1d\n" +
	...
	"\x05todos\x18\x01 \x03(\v2\r.todo.v1.TodoR\x05todos\"\xad\x01\n" +
	"\x11UpdateTodoRequest\x12\x17\n" +
	"\x02id\x18\x01 \x01(\x05B\a\xbaH\x04\x1a\x02 \x00R\x02id\x12 \n" +
	"\x05title\x18\x02 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xff\x01R\x05title\x12/\n" +
	"\vdescription\x18\x03 \x01(\tB\b\xbaH\x05r\x03\x18\xe8\aH\x00R\vdescription\x88\x01\x01\x12\x1c\n" +
	"\tcompleted\x18\x04 \x01(\bR\tcompletedB\x0e\n" +
	"\f_description\"7\n" +
	...
	"\n" +
	"DeleteTodo\x12\x1a.todo.v1.DeleteTodoRequest\x1a\x1b.todo.v1.DeleteTodoResponse\"\x00B\x7f\n" +
	"\vcom.todo.v1B\tTodoProtoP\x01Z(sinat/todo-go-backend/gen/todo/v1;todov1\xa2\x02\x03TXX\xaa\x02\aTodo.V1\xca\x02\aTodo\\V1\xe2\x02\x13Todo\\V1\\GPBMetadata\xea\x02\bTodo::V1b\x06proto3"
...
var file_todo_v1_todo_proto_depIdxs = []int32{
	...
	6,  // 11: todo.v1.TodoService.ListTodos:output_type -> todo.v1.ListTodosResponse
